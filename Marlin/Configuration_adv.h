 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD     60  // Seconds [BH] default 40
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD   30  // Seconds [BH] default 20
...
#define DAC_MOTOR_CURRENT_DEFAULT { 40, 40, 40, 40 }     // Default drive percent - X, Y, Z, E axis  70, 80, 90, 80 [robo]
