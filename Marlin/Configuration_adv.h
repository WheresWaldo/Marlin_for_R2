...
//#define FILAMENT_WIDTH_SENSOR
  ...
  #define MEASURED_UPPER_LIMIT         1.85 // (mm) Upper limit used to validate sensor reading  [BH]
  #define MEASURED_LOWER_LIMIT         1.65 // (mm) Lower limit used to validate sensor reading  [BH]
