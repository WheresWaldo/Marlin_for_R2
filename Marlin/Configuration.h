...
#define STRING_CONFIG_H_AUTHOR "([BH][robo])" // Who made the changes.  [BH]
...
#define HEATER_0_MAXTEMP 320  //Hexagon @ 300, E3D @ 320  [BH]
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 287.07  //[BH]	107.41 [robo]
...
//#define MAX_SOFTWARE_ENDSTOPS  [BH]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET        15  // Set Mesh bounds as an inset region of the bed  [BH]
